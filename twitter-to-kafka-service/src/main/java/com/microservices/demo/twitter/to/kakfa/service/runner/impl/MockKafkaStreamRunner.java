...
import com.microservices.demo.twitter.to.kakfa.service.exception.TwitterToKafkaServiceException;
...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    private void sleep(long sleepTimeMs) throws InterruptedException {
        try {
    ...
    private static String formatTweetsAsJsonWithParams(String[] params) {
